...
const InputSelect: React.FC<InputSelectProps> = (props) => {
  ...
  useHandleClickOutside<HTMLDivElement>(refEl, (e: any) => {
    setfocus(false);
    setisOpened(false);
    refEl.current?.blur();
  });
