...
const FormButton: React.FC<FormButtonProps> = (props) => {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      className={`my-2 relative app_form_button active:shadow-app_form_button_active focus:shadow-app_form_button_focus text-[14px] font-[500] ${style}  ${props.tailwindStyles}`}>
